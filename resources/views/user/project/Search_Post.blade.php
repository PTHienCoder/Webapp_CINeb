	...
	<div class="col-sm-10">
                 <div class="shop-p">
                                            ...
                                            <div class="empty__wrap">
                                                ...
                                                <div class="empty__search-form">
                                                    <input class="input-text input-text--primary-style input_search" type="text" id="search-label" placeholder="Search Keywords">
                                                       <span class="icon_seacrh"><button class="btn btn--icon fas fa-search" type="button"></button></span>  
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="shop-p__collection" style="margin-top:30px">
                                   ...
                                   <div class="row is-grid-active" id="load_post_key_search" style="margin-top: 20px;">
...
<script type="text/javascript">
 ...
 var key_search = $("#key_search").val();
  load_post_key_search(key_search);
  $('.input_search').val(key_search);
    ...
    $(".input_search").keyup(function(){
         ...
         $('.icon_seacrh').html('<button class="btn btn--icon mdi mdi-close btn_removekeys" type="button"></button>') 
           load_post_key_search($('.input_search').val());
         }else{
    ...
    $(document).on('click', '.btn_removekeys', function(){  
      ...
      function load_post_key_search(key_search){   
           var _token = $('input[name="_token"]').val();
            $.ajax({
            url:"{{url('/load_post_key_search')}}",
            method:"POST",
            dataType:'JSON', 
            headers: {
           'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
             ...
             _token:_token},
              ...
              $('#load_post_key_search').html(data.data_result);
