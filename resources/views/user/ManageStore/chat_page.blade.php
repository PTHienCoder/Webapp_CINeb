                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active p-3" id="newpost">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div data-simplebar="" style="height: 550px" class="loadUser_Chat_store">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="mt-3 mb-1"><strong><i class='uil uil-location'></i> Birthday:</strong></p>
                                            <p class="address"></p>
...
<script type="text/javascript">
	 $(document).ready(function(){
      ...
      $('.div_senchat').hide();
          ...
          var id_fr = 0;
           function loadUser_Chat_store(){  
                    var _token = $('input[name="_token"]').val();
                    $.ajax({
                        url:'{{url('/loadUser_Chat_store')}}',
                        method:"GET",
                        headers:{
	 	   ...
	 	   $(document).on('click', '.item_user', function(e) {
                e.preventDefault();  
                  $('.div_inf_user').show();
                   $('.div_senchat').show();
                  var id_user = $(this).closest(".item_user").find(".id_user").val();
                  load_Infor_user_chat(id_user)
                     id_fr = id_user;
                            setInterval(function() {
                                   load_Infor_user_chat(id_fr);
                                    }, 300)
	      ...
	      function load_Infor_user_chat(id_user){  
                    var _token = $('input[name="_token"]').val();
                    $.ajax({
                        url:'{{url('/load_Infor_user_chat')}}',
                        method:"GET",
                        dataType:'JSON',
                        headers:{
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
